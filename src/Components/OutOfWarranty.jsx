  ...
  return (
    <>
      ...
      <Row className="mb-2">
        <Col md={6} sm={12}>
          <Form.Group>
            <Form.Label>Out Of Warranty</Form.Label>
            <div className="d-flex align-items-center" style={{ gap: 12 }}>
              <Form.Check
                ...
                name="outOfWarranty"
                value={true}
                checked={formData.outOfWarranty === true}
                onChange={handleChange}
                disabled={disabled}
              />
              {/* <Form.Check
                ...
                name="outOfWarranty"
                value={false}
                checked={formData.outOfWarranty === false}
                onChange={handleChange}
                disabled={disabled}
              /> */}
            </div>
...
const OutOfWarranty = ({ orderData, setIsEdit }) => {
        ...
        <Modal.Header>
          ...
          <button className="btn bg-transparent close-button">
            <i
              ...
              onClick={()=>{handleCloseCaseModal();closeNewOrdersModal()}}
            ></i>
          </button>
        </Modal.Header>
        <Modal.Body>
